                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input class="form-control" placeholder="Giá"
                                                       value="{{ old('price') }}" name="price" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input class="form-control" placeholder="Giảm giá" name="discount"
                                                       value="{{ old('discount') }}" id="" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input class="form-control" placeholder="Số buổi học" name="number_of_session"
                                                       value="{{ old('number_of_session') }}" id="website" type="number">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input class="form-control" placeholder="Số buổi học" name="study_time"
                                                       value="{{ old('study_time') }}" id="website" type="date">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <select class="form-control" name="type_customer" id="type_customer" required>
                                                    <option disabled selected> -- Chọn --</option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input class="form-control" placeholder="Yêu cầu đầu vào" name="input_requirement"
                                                       value="{{ old('input_requirement') }}"  type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
